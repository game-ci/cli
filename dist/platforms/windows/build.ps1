...
{
    if (Test-Path -Path "c:\GameCISettingsApplier\Assets\Editor")
    {
        ...
        Copy-Item -Path "c:\GameCISettingsApplier\Assets\Editor\*" -Destination $Env:UNITY_PROJECT_PATH\Assets\Editor -Recurse -Force
    }
    else
    {
