...
# Usage: curl -fsSL https://raw.githubusercontent.com/game-ci/orchestrator/main/install.sh | sh
#
...
detect_platform() {
  ...
  case "$OS" in
    ...
    MINGW*|MSYS*|CYGWIN*)
      ...
      warn "  irm https://raw.githubusercontent.com/game-ci/orchestrator/main/install.ps1 | iex"
      ;;
