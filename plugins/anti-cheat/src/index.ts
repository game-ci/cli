...
export const antiCheatPlugin = {
  ...
  async onLoad() {
    console.warn(
      "[game-ci] WARNING: @game-ci/anti-cheat is an EXPERIMENTAL draft plugin. " +
        "It registers options but does not yet wrap any build output - it is not integrated " +
        "into the build lifecycle. Do not depend on it. See plugins/anti-cheat/README.md.",
    );
  },
};
